...
export const B64 = {
  ...
  base64DecToArr: function (sBase64, nBlocksSize) {
    ...
    const nOutLen = nBlocksSize ? Math.ceil((nInLen * 3 + 1 >> 2) / nBlocksSize) * nBlocksSize : nInLen * 3 + 1 >> 2, taBytes = new Uint8Array(nOutLen)
  ...
  strToB64: function (text) {
    return this.base64EncArr(this.strToUTF8Arr(text))
  },

  b64ToStr: function (text) {
    return this.UTF8ArrToStr(this.base64DecToArr(text))
  }
}
